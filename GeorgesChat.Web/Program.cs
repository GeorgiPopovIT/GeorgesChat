...
var connectionString = builder.Configuration.GetConnectionString("GeorgesChatDbContextConnection") ?? throw new InvalidOperationException("Connection string 'DefaultConnection' not found.");
